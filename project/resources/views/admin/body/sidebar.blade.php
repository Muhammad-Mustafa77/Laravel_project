        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="amenitie">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="#" class="nav-link">All Aminitie</a>
                </li>
                <li class="nav-item">
                  <a href="pages/email/read.html" class="nav-link">Add Aminitie</a>
                </li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="advancedUI">
              <ul class="nav sub-menu">
                ...
                <li class="nav-item">
                  <a href="#" class="nav-link">Roles in Permission</a>
                </li>
                <li class="nav-item">
                  <a href="#" class="nav-link">All Roles in Permission</a>
                </li>
              </ul>
            </div>
          </li>
